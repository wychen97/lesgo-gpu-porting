...
character (128) :: fphi_out
character (128) :: fphi_raw_out
character (128) :: fbrindex_out
character (128) :: fbrindex_raw_out
...
fbrindex_out = path // 'brindex.dat'
fbrindex_raw_out = path // 'brindex.out'
