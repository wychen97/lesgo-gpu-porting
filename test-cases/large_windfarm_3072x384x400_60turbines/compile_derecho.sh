...
# ATM wind-farm build name from the root CMakeLists.txt:
#   lesgo + mpi + ATM + lesgpu -> lesgo-mpi-ATM-lesgpu
install -m 0755 "${BUILD_DIR}/lesgo-mpi-ATM-lesgpu" "${CASE_DIR}/lesgo-run-exe"
