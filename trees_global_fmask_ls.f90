...
logical function global_fmask_cuda_enabled()
!*******************************************************************************
implicit none

global_fmask_cuda_enabled = .true.

end function global_fmask_cuda_enabled
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine calc_global_fmask_gpu(br_l, br_d, eps, br_x0, br_abs_dir)
implicit none
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine filter_global_fmask_gpu(wksp)
implicit none
