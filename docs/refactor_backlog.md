...
| 6 | `level_set_gpu.f90` | 61,377 bytes | Keep workspace ownership, stress treatment, smoothing, SGS, and packed-halo sections navigable; split only with the dedicated Level Set matrix in place. |
