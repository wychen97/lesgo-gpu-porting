...
| 4 | `scalars.f90` | 63,417 bytes | Separate scalar transport, halo handling, and timing diagnostics. |
...
| 8 | `iwmles.f90` | 52,801 bytes | Separate wall-model paths after preserving identical `(i,j)` surface-field semantics. |
