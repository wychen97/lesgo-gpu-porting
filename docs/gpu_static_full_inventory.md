...
| `input_util.f90:568` | `output_block` | `host-boundary` |  |  |
| `input_util.f90:673` | `level_set_block` | `host-boundary` |  |  |
| `input_util.f90:756` | `turbines_block` | `host-boundary` |  |  |
| `input_util.f90:839` | `scalars_block` | `host-boundary` |  |  |
| `input_util.f90:903` | `checkentry` | `host-boundary` |  |  |
| `input_util.f90:918` | `readline` | `host-boundary` |  |  |
| `input_util.f90:959` | `parse_vector_real` | `host-boundary` |  |  |
| `input_util.f90:994` | `parse_vector_point3D` | `host-boundary` |  |  |
...
| `main.f90:1052` | `main_read_env_real` | `host-or-diagnostic` |  |  |
...
| `turbines.f90:1182` | `turbines_finalize` | `gpu-marked` |  |  |
| `turbines.f90:1202` | `turbines_checkpoint` | `host-or-diagnostic` |  |  |
| `turbines.f90:1227` | `turbine_vel_init` | `host-or-diagnostic` |  |  |
| `turbines.f90:1267` | `place_turbines` | `unmarked-runtime-candidate` | `adm-cpu-fallback-profile` | `adm_disk`, `adm_dynamic_controls` |
| `turbines.f90:1417` | `read_control_files` | `host-or-diagnostic` |  |  |
