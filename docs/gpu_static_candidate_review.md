...
| `scalars.f90:866` | `ic_scal_file` | `scalar-init-fallback` | `scalar_passive`, `scalar_active`, `cps_scalar` |
| `scalars.f90:886` | `ic_scal_les` | `scalar-init-fallback` | `scalar_passive`, `scalar_active`, `cps_scalar` |
| `scalars.f90:905` | `ic_scal_interp` | `scalar-init-fallback` | `scalar_passive`, `scalar_active`, `cps_scalar` |
