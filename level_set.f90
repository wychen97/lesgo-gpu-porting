...
character (128) :: fphi_in_base, fnorm_out_base
...
!  Initialize values
fname_write = path // 'output/level_set_vel_err.dat'
uv_err_navg = 0
w_err_navg = 0
u_err = 0._rprec
v_err = 0._rprec
...
fprefix = path // 'output/interp_tau.'
