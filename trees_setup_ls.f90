...
logical function trees_setup_cuda_enabled()
!*******************************************************************************
implicit none

trees_setup_cuda_enabled = .true.

end function trees_setup_cuda_enabled
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine sdistfcn_branch_square_gpu(ip, mx, phi, brident, ident, l, rb0,    &
                                      rbl, tgt, sine, cosine, br_x0,          &
                                      br_abs_dir, br_x_hat, br_y_hat,         &
                                      br_z_hat)
implicit none
